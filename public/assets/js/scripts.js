				...
				<div class="container px-4 px-lg-5">
					...
					<div class="collapse navbar-collapse" id="navbarResponsive">
						<ul class="navbar-nav ms-auto py-4 py-lg-0">
							...
							<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/public/about.html">About</a></li>
							<!-- <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/public/contact.html">Contact</a></li> -->
						</ul>
					</div>
				</div>
			</nav>
